  ...
  <div class="privacy-policy">
    <div class="container">
      ...
      <div class="content">
        <section>
          <h2>1. 信息收集</h2>
          <p>我们不会收集任何个人信息。本网站仅提供影视资源导航服务，不存储任何用户数据。</p>
        </section>

        <section>
          <h2>2. Cookie 使用</h2>
          <p>本网站不使用 Cookie 或其他追踪技术。</p>
        </section>

        <section>
          <h2>3. 第三方链接</h2>
          <p>本网站包含指向第三方网站的链接。这些网站有其自己的隐私政策，我们建议您查看这些政策。我们对这些第三方网站的内容和隐私做法不承担任何责任。</p>
        </section>

        <section>
          <h2>4. 安全措施</h2>
          <p>我们采取适当的技术措施来保护网站的安全性。但请注意，互联网传输数据并非100%安全，我们不能保证信息的绝对安全性。</p>
        </section>

        <section>
          <h2>5. 政策更新</h2>
          <p>我们可能会不时更新本隐私政策。更新后的政策将在本页面上发布。</p>
        </section>
