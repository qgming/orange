<template>
  <div class="videoList">
    <SectionBlock title="官方影视" :items="officialChannels" />
    <SectionBlock title="免费影视" :items="freeChannels" />
    <SectionBlock title="在线游戏" :items="gameResources" />
    <SectionBlock title="图书资源" :items="bookResources" />
    <SectionBlock title="软件游戏" :items="softwareGameResources" />
    <SectionBlock title="AI工具" :items="aiResources" />
    <SectionBlock title="极客社区" :items="communityChannels" />
    <SectionBlock title="学习资源" :items="learningResources" />
    <SectionBlock title="音乐资源" :items="musicResources" />
    <SectionBlock title="网盘磁力" :items="diskSearch" />
    <SectionBlock title="友情链接" :items="friendLinks" />
  </div>
  <div class="footer">
...
const softwareGameResources = ref([
  ...
  },
  {
    ...
    description: '独立游戏分享平台，支持免费下载'
  },
  {
    id: 16,
    title: 'Itch.io',
    url: 'https://itch.io',
    description: '独立游戏发布平台，大量免费游戏'
  },
  {
    id: 17,
    title: 'Humble Bundle',
    url: 'https://www.humblebundle.com',
    description: '游戏捆绑包销售平台，经常有免费游戏'
  },
  {
    id: 18,
    title: 'IndieDB',
    url: 'https://www.indiedb.com',
    description: '独立游戏展示平台，提供游戏下载'
  },
  {
    id: 19,
    title: 'GameTop',
    url: 'https://www.gametop.com',
    description: '提供免费PC游戏下载，无需注册'
  },
  {
    id: 20,
    title: 'My Abandonware',
    url: 'https://www.myabandonware.com',
    description: '经典老游戏下载站，完全免费'
  },
]);
//音乐资源
